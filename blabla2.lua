...
local CounterFollow = false -- NEW: Khusus Counter Dummy
...
local Window = Rayfield:CreateWindow({
    Name = "Auto Gojo (Counter Follow Added)",
    LoadingTitle = "System Loaded",
    LoadingSubtitle = "Counter Dummy Tracking Optimized",
...
-- =======================================================
-- ===== UNIFIED FOLLOW SYSTEM (INCL. COUNTER) ==========
-- =======================================================
RunService.Heartbeat:Connect(function()
    ...
    -- === 1. COUNTER FOLLOW LOGIC (PRIORITY) ===
    if CounterFollow then
        local dummy = Workspace.Living:FindFirstChild("Counter Dummy")
        if dummy and dummy:FindFirstChild("HumanoidRootPart") then
            local thrp = dummy.HumanoidRootPart
            -- Teleport 26 studs di atas Dummy (Safezone Udara)
            hrp.CFrame = CFrame.new(thrp.Position + Vector3.new(0, 0, -3), thrp.Position)
            hrp.Velocity = Vector3.zero
            hrp.AssemblyLinearVelocity = Vector3.zero
            return -- Stop here agar tidak bentrok
        end
    end

    -- === 2. PLAYER TARGET SELECTION ===
    ...
    -- === 3. PLAYER FOLLOW LOGIC ===
    if HollowFollow or RedFollow then
        -- Teleport 26 studs di atas Player
        hrp.CFrame = CFrame.new(thrp.Position + Vector3.new(0, 26, 0), thrp.Position)
        hrp.Velocity = Vector3.zero 
        hrp.AssemblyLinearVelocity = Vector3.zero

    elseif FollowTarget then
        -- Teleport biasa (Combat)
