...
local AutoGojoRework = false -- Variable Baru ditambahkan agar tidak error
local AutoRed = false
...
-- ===== AUTO BACKGROUND REFRESH TARGET (FIXED) =====
task.spawn(function()
    while task.wait(1) do
...
task.spawn(function()
    while true do
        ...
        local targetName = "Counter Dummy" -- Ganti nama target jika perlu
