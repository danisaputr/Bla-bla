...
task.spawn(function()
    while true do
        ...
        if AutoGojo then
            ...
            -- WAIT 1 DETIK & TP (Request User)
            task.wait(1)
            if hrp then hrp.CFrame = CFrame.new(-43, -116, 359) end
            
            task.wait(0.5) -- Sisa delay
            ...
            local maxWait = 0
            while StandName.Value ~= "Gojo Satoru" and maxWait < 10 do
                task.wait(0.5)
                maxWait = maxWait + 1
                if StandName.Value == "Standless" then
                    pcall(function() Slot3:FireServer() end)
    ...
    while true do
        ...
        if AutoRedRework then
            ...
            if StandName.Value == "Standless" then
                ...
                task.wait(1)
                if hrp then hrp.CFrame = CFrame.new(-43, -116, 359) end
            end -- END ADDED HERE (Perbaikan Struktur)

            -- 3. Cek apakah sudah Gojo Satoru
            local maxWait = 0
            while StandName.Value ~= "Gojo Satoru" and maxWait < 10 do
                task.wait(0.5)
                maxWait = maxWait + 1
