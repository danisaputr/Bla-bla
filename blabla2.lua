...
-- =======================================================
-- ===== AUTO KING MON LOGIC (NO ANDERSON) ===============
-- =======================================================
task.spawn(function()
    while true do
        task.wait(1)
        ...
        -- [STEP 4] SUMMON PHASE (Jika sudah punya Holy Nail)
        if nailCount > 0 then
            -- Teleport ke Ruined City Spawn
            local map = Workspace:FindFirstChild("Map")
        ...
        -- [STEP 3] TURN IN PHASE (Hanya jika Punya Quest & Ada Soul)
        if HasQuest110 and soulCount > 0 then
            ...
            task.wait(0.5) 
            continue -- Loop ulang untuk memastikan item berkurang
        end
        
        -- CATATAN:
        -- Jika HasQuest110 = TRUE dan soulCount = 0 (Habis), script akan IDLE di sini.
        -- Logika ke Anderson telah DIHAPUS sesuai permintaan.
        -- Script akan lanjut otomatis hanya jika kamu mendapatkan Holy Nail (masuk Step 4).
