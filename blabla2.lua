...
local HollCFrame.new(thrp.Position + Vector3.new(-15, 25, 0), thrp.Position)
            hrp.Velocity = Vector3.zero 
            hrp.AssemblyLinearVelocity = Vector3.zeroowFollow = false
...
RunService.Heartbeat:Connect(function()
    ...
    elseif PurpleFollow then
        ...
        if target and target:FindFirstChild("HumanoidRootPart") then
            ...
            hrp.CFrame = CFrame.new(targetHRP.Position + Vector3.new(-15, 26, 0), targetHRP.Position)
            hrp.Velocity = Vector3.zero
            hrp.AssemblyLinearVelocity = Vector3.zero
        end
