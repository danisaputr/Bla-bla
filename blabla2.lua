...
RunService.Heartbeat:Connect(function()
    ...
    -- [UPDATE] MENAMBAHKAN Z MOVE & H MOVE KE LOGIC INI
    elseif HollowFollow or RedFollow or ZMoveFollow or HMoveFollow then
        local activeTarget = nil
        if AutoRed then activeTarget = CurrentRedTarget
        elseif AutoZMove then activeTarget = CurrentZMoveTarget
        elseif AutoHMove then activeTarget = CurrentHMoveTarget -- Added check
